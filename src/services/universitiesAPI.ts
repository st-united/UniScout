...
import { API_URL } from '@app/constants'; // Assuming API_URL is defined here
/**
...
export const getUniversitiesAPI = async (params?: GetUniversitiesParams) =>
  await axiosInstance.get(API_URL.UNIVERSITIES, { params });
/**
...
export const getUniversityByIdAPI = async (id: number) =>
  await axiosInstance.get<UniversityDetail>(`${API_URL.UNIVERSITIES}/${id}`);
/**
...
export const updateUniversity = async (university: UniversityDetail) =>
  await axiosInstance.patch<void>(`${API_URL.UNIVERSITIES}/${university.id}`, university);
/**
...
export const deleteUniversityAPI = async (id: number) =>
  await axiosInstance.delete<void>(`${API_URL.UNIVERSITIES}/${id}`);
/**
...
export const createUniversity = async (formData: FormData) =>
  await axiosInstance.post<UniversityDetail>(API_URL.UNIVERSITIES, formData, {
